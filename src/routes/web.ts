...
import { getCartPage, getCheckoutPage, getProductDetail, postAddProductToCart, postDeleteProductInCart, postHandleCartToCheckout } from 'controllers/client/product/product.controller';
